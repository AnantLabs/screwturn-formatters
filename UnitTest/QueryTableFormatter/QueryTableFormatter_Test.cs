...
namespace UnitTest
{
    ...
    public class QueryTableFormatter_Test
    {
        ...
        private const string MsSql = "{MyLink=MsSql,Data Source=SAVANNAH\\SQLEXPRESS;Initial Catalog=wiki;User ID=wiki;Password=myretuefest;}";
        private const string MySql = "{MyLink=MySql,Database=wiki;Data Source=192.168.1.100;User Id=wiki;Password=myretuefest;}";
        private const string SqLite = "{MyLink=SqLite,Data Source=D:\\My Documents\\Visual Studio 2008\\Projects\\ScrewTurn\\Common\\Database\\Wiki.sqlite;Version=3;}";
