...
namespace Keeper.Garrett.ScrewTurn.Utility
{
    public class Gravatar
    {
        ...
        /// </summary>
        public static string GenerateGravatarLink(string _email)
        {
            string retval = string.Empty;

            _email = (string.IsNullOrEmpty(_email) == true ? "Missing User Email" : _email);
            retval = string.Format(@"<img src=""http://www.gravatar.com/avatar/{0}?d=identicon"" alt=""Gravatar"" height=""80"" width=""80"" />", GetGravatarHash(_email));
